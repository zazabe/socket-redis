...
module.exports = (function() {
	...
	var adaptData = function(systemData) {
		var userData = systemData.data;
		if (typeof(userData.channel) == 'undefined') {
			userData.channel = new String('null:null');
		}
		if (typeof(userData.event) == 'undefined') {
			userData.event = new String();
		}
		if (typeof(userData.data) == 'undefined') {
			userData.data = new String();
		}
	};
