...
Worker.prototype.triggerEventDown = function(type, data) {
  switch (type) {
    ...
    case 'down-status-request':
      this.sendUpStatusRequest(data.requestId, this._getChannelsData());
      break;
    default:
...
Worker.prototype.sendUpPublish = function(channelId, event, data) {
 ...
 * @param {Object} data
 */
Worker.prototype.sendUpMessage = function(clientKey, data) {
 ...
 * @param {Object} data
 */
Worker.prototype.sendUpSubscribe = function(channel, clientKey, data) {
 ...
 * @param {String} clientKey
 */
Worker.prototype.sendUpUnsubscribe = function(channel, clientKey) {
 ...
 */
Worker.prototype.sendUpStatusRequest = function(requestId, channelsData) {
